...
local NOTT= "\n|cffff0000條件取反: |cffffffffAlt + 鼠標左鍵";
...
function addon:OnMenuRequest(level, value, menu, MenuEx,GlobalLevel)
	...
	if level == 1 then -- 1級菜單內容
		...
		if Type=="Select" or Type=="Edit" then
			...
			menu:AddLine("text", "|cff00ffff新建目標","hasEditBox", 1, "editBoxText", self.text,
			"editBoxFunc", "AddCustomizeTarget", "editBoxArg1", self,"tooltipText",str,"tooltipTitle",
			"新建目標","icon","INTERFACE\\ICONS\\Ability_Hunter_SniperShot")
			...
			--**--
				...
				if Type=="Select" then
					...
					if RDB[index].types=="unit" then
						...
						"tooltipText",str,"tooltipTitle","目標名稱",
					...
					elseif RDB[index].types=="function" then
						...
						local str = addon:FormatTooltipText("把函數返回值（字符串）設為目標");
						str = str .. text;
						...
						"tooltipTitle","函數設定目標","tooltipText",str,
						"OpenRightMenu",SuperTreatment["Menu"]["OpenRightMenu"],
						"OpenRightMenuValue",tbl,
					...
					elseif RDB[index].types=="AmminimumFast" then
						...
						local str = addon:FormatTooltipText("通過模板的設定獲得目標,非常簡單的從一堆目標里找出你需要的目標");
						str = str .. text;
						...
						"tooltipTitle","模板設定目標","tooltipText",str,
						"OpenRightMenu",SuperTreatment["Menu"]["OpenRightMenu"],
						"OpenRightMenuValue",tbl,
	...
	elseif level == 2 then -- 2級菜單內容
		...
		if value[1] == "CustomizeTargetListGetTargetAmminimumFast" then
			...
			local str = addon:FormatTooltipText("影響當前層及所有子菜單的判斷目標。")
			
			menu:AddLine("text", "|cffffff00設定目標范圍" ,"hasArrow", 1, "value",
			...
			local str = addon:FormatTooltipText("設定需要滿足條件的Buff。\n\n|r如:需要補的Buff。")
			
			menu:AddLine("text", "|cffffff00設定Buff條件" ,"hasArrow", 1, "value", 
			...
			local str = addon:FormatTooltipText("設定需要排除的Buff。\n\n|r如:有無敵的時候我不攻擊。")
			...
			menu:AddLine("text", "|cffffff00讀條技能" ,"hasArrow", 1,
			...
			--[[
			menu:AddLine("text", "|cffffff00讀條技能" ,"hasArrow", 1, "value", 
			...
			menu:AddLine("text", "|cffffff00排除的職業" ,"hasArrow", 1, "value", 
			...
			menu:AddLine("text", "|cffffff00獲得最小的" ,"hasArrow", 1, "value",
			...
			menu:AddLine("text", "|cffffff00獲得最大的" ,"hasArrow", 1, "value",
			...
			local str = addon:FormatTooltipText("從代碼返回表達式結果作為條件。\n內部變量 unit 是目標的ID。");
				menu:AddLine("text", "|cffffff00從代碼獲得|r","hasEditBox", 1, "editBoxText", tbl["Code"], "editBoxFunc", "SetSlider", "editBoxArg1", self,"editBoxArg2", 
				{tbl,"Code",level},
	...
	elseif level == 3 then -- 2級菜單內容
		...
		elseif value[1] == "CustomizeTargetListGetTargetAmminimumFastMaximum" then
			...
			menu:AddLine("text", "|cffffffff最大Buff層數(|cffff0000>=" .. value["MaximumLayerBuff"]  .."|cffffffff)", "hasArrow", 1, "value",
			...
			str = addon:FormatTooltipText("從代碼返回表達式（字符串）結果作為條件，需要返回2個值。\n第1個是條件表達式的結果。\n第2個是表達式的結果為數值作為判斷最小值的依據。\n內部變量 unit 是目標的ID。");
				menu:AddLine("text", "|cffffffff從代碼獲得|r","isRadio", 1,"hasEditBox", 1, "editBoxText", value["MaximumCode"], "editBoxFunc", "SetSliderMaxMG", "editBoxArg1", self,"editBoxArg2",
		...
		elseif value[1] == "CustomizeTargetListGetTargetAmminimumFastMinimum" then
			...
			menu:AddLine("text", "|cffffffff最小距離內(|cffff0000<=" .. value["MinimumDistanceValue"]  .."|cffffffff)","isRadio", 1,"checked",
			...
			menu:AddLine("text", "|cffffffff最小Buff層數(|cffff0000<=" .. value["MinimumLayerBuff"]  .."|cffffffff)", "hasArrow", 1, "value",
			...
			str = addon:FormatTooltipText("從代碼返回表達式（字符串）結果作為條件，需要返回2個值。\n第1個是條件表達式的結果。\n第2個是表達式的結果為數值作為判斷最小值的依據。\n內部變量 unit 是目標的ID。");
				menu:AddLine("text", "|cffffffff從代碼獲得|r","isRadio", 1,"hasEditBox", 1, "editBoxText", value["MinimumCode"], "editBoxFunc", "SetSliderMG", "editBoxArg1", self,"editBoxArg2",
		...
		elseif value[1] == "CustomizeTargetListGetTargetAmminimumFastSetSpell" then
			...
			menu:AddLine("text", "|cffffffff剩余(|cffff0000<=" .. SpellValuePoorvalue  .."|cffffffff)秒時",
			...
			local str = addon:FormatTooltipText("判斷可以打斷的技能那么你把該選項打勾。\n\n|r注意：當有列表時對其過濾，當選 [|cff00ffff忽略列表,判斷任何技能|r] 時對任何技能過濾。");
			menu:AddLine("text", "|cffffff00可打斷的技能","checked",tbl["InterruptChecked"],
			"func", "SetTbl","arg1", self,"arg2",
			...
			menu:AddLine("text", "|cffffff00忽略列表,判斷任何技能","checked",tbl["AllSpell"],"func", "SetTbl","arg1", self,"arg2",
		...
		elseif value[1] == "CustomizeTargetListGetTargetAmminimumFastSetGroup" then
			...
			"tooltipTitle","說明","disabled",not disabled);
			...
			menu:AddLine("text", text,"isRadio", 1, "checked",AMF["SpellDistanceChecked"] ,"func", "CustomizeTargetListGetTargetAmminimumFastSetGroup_SpellDistancechecked","arg1", self,"arg2", index,"tooltipText",str,"tooltipTitle","說明")
			
			
			local text = "|cffffffff距離(|cffff0000<=" .. AMF["Distancevalue"]  .."|cffffffff)的目標";
			local str = addon:FormatTooltipText("過濾目標和你之間的距離");
			menu:AddLine("text", text,"isRadio", 1, "checked",AMF["DistanceChecked"] ,"func", "CustomizeTargetListGetTargetAmminimumFastSetGroup_Distancechecked","arg1", self,"arg2", index,"hasSlider", 1,"sliderDecimals",0, "sliderValue", AMF["Distancevalue"], "sliderMin", 5, "sliderMax", 50, "sliderStep", 1, "sliderFunc", "CustomizeTargetListGetTargetAmminimumFastSetGroup_Distancevalue", "sliderArg1", self,"sliderArg2", index,"tooltipText",str,"tooltipTitle","說明")
			...
			menu:AddLine("text", "常用目標","isTitle",1,
			...
			if not ST.Hide_old_version_of_the_target then
				...
				local str = addon:FormatTooltipText("超級助手里設定的MT列表。\n\n|r提示：菜單[全局快速設定] >> [MT設定]");
				
				menu:AddLine("text", Colors .. "所有MT","isRadio", 1,"checked",group=="maintank","func", func,"arg1", self,"arg2", {AMF,"group","maintank",level -1},
				"tooltipText",str,"tooltipTitle","說明"
				);
				
				menu:AddLine("text", Colors .. "小隊","isRadio", 1,"checked",group=="party","func", func,"arg1", self,"arg2", {AMF,"group","party",level -1});
				
				menu:AddLine("text", Colors .."小隊寵物","isRadio", 1,"checked",group=="partypet","func", func,"arg1", self,"arg2", {AMF,"group","partypet",level -1});
				
				menu:AddLine("text", Colors .."團隊","isRadio", 1,"checked",group=="raid","func", func,"arg1", self,"arg2", {AMF,"group","raid",level -1});
				
				menu:AddLine("text", Colors .."團隊寵物","isRadio", 1,"checked",group=="raidpet","func", func,"arg1", self,"arg2", {AMF,"group","raidpet",level -1});
				
				menu:AddLine("text", Colors .. "小隊/團隊","isRadio", 1,"checked",group=="partyraid","func", func,"arg1", self,"arg2", {AMF,"group","partyraid",level -1});
				
				menu:AddLine("text", Colors .. "小隊/團隊(寵物)","isRadio", 1,"checked",group=="partyraidpet","func", func,"arg1", self,"arg2", {AMF,"group","partyraidpet",level -1});
				
				
				menu:AddLine("text", Colors .."競技場敵方小隊","isRadio", 1,"checked",group=="arena","func", func,"arg1", self,"arg2", {AMF,"group","arena",level -1});
				
				menu:AddLine("line",1,"LineBrightness",1,"LineHeight",10);
			end		
					--menu:AddLine("text", "隱藏了舊版本的一些目標","isTitle",1);
					local str = addon:FormatTooltipText("目標調用少于1次的強力建議不要使用，這些目標完全可以用施法方案里的條件目標代替。|r\n\n但如果多次調用那么強烈建議使用，因為更有效率。");
					
					
						menu:AddLine("text", "更多目標","isTitle",1,
						"ToggleButton",1,"ToggleButtonFun",function()
						ST.Hide_old_version_of_the_target=not ST.Hide_old_version_of_the_target;
						DropDownMenu:Refresh(level);
			...
			if ST.Hide_old_version_of_the_target then
				...
				menu:AddLine("text", Colors .."寵物","isRadio", 1,"checked",group=="pet","func", func,"arg1", self,"arg2", {AMF,"group","pet",level -1})
				
				
				menu:AddLine("text", Colors .."當前目標","isRadio", 1,"checked",group=="target","func", func,"arg1", self,"arg2", {AMF,"group","target",level -1})
				
				menu:AddLine("text", Colors .."當前目標的目標","isRadio", 1,"checked",group=="targettarget","func", func,"arg1", self,"arg2", {AMF,"group","targettarget",level -1})
				
				menu:AddLine("text", Colors .."焦點目標","isRadio", 1,"checked",group=="focus","func", func,"arg1", self,"arg2", {AMF,"group","focus",level -1})
				
				menu:AddLine("text", Colors .."焦點目標的目標","isRadio", 1,"checked",group=="focustarget","func", func,"arg1", self,"arg2", {AMF,"group","focustarget",level -1})
				
				menu:AddLine("text", Colors .."鼠標目標","isRadio", 1,"checked",group=="mouseover","func", func,"arg1", self,"arg2", {AMF,"group","mouseover",level -1})
				
				menu:AddLine("text", Colors .."鼠標目標的目標","isRadio", 1,"checked",group=="mouseovertarget","func", func,"arg1", self,"arg2", {AMF,"group","mouseovertarget",level -1})
			
				menu:AddLine("text", Colors .."你控制的車輛","isRadio", 1,"checked",group=="vehicle","func", func,"arg1", self,"arg2", {AMF,"group","vehicle",level -1})
	...
	elseif level == 4 then -- 4級菜單內容
		...
		if value[1] ==  "CustomizeTargetListGetTargetAmminimumFastMaximumLayerBuff" then
			...
			menu:AddLine("text", "|cffffff00最大Buff層數(|cffff0000>=" .. value["MaximumLayerBuff"]  .."|cffffff00)","hasSlider", 1, "sliderValue", value["MaximumLayerBuff"], "sliderMin", 0, "sliderMax", 1000, "sliderStep", 1, "sliderFunc", "SetSliderMaxMG", "sliderArg1", self,"sliderArg2", 
			...
			menu:AddLine("text", "|cffffff00輸入Buff名稱","colorCode","|cffffff00","hasEditBox", 1, "editBoxText",Name or "" , "editBoxFunc", "LayerBuff_Max_AddBuff", "editBoxArg1", self,"editBoxArg2",
			...
			CollectionInf["Buff_Spell"]["Ex"]=SuperTreatmentDBF["CollectionInf"];
			menu:AddLine("text", "|cffffff00選擇Buff名稱","colorCode","|cffffff00",
			"hasArrow", 1,
			"OpenMenu",SuperTreatment["Menu"]["UnitBuffListMenu"],
		...
		elseif value[1] ==  "CustomizeTargetListGetTargetAmminimumFastMinimumLayerBuff" then	
			...
			menu:AddLine("text", "|cffffff00最小Buff層數(|cffff0000<=" .. value["MinimumLayerBuff"]  .."|cffffff00)","hasSlider", 1, "sliderValue", value["MinimumLayerBuff"], "sliderMin", 0, "sliderMax", 1000, "sliderStep", 1, "sliderFunc", "SetSliderMG", "sliderArg1", self,"sliderArg2", 
			...
			menu:AddLine("text", "|cffffff00輸入Buff名稱","colorCode","|cffffff00","hasEditBox", 1, "editBoxText",Name or "" , "editBoxFunc", "LayerBuff_AddBuff", "editBoxArg1", self,"editBoxArg2",
			{value,"NewLayerBuffId",level,value}
			);
		...
		elseif value[1] == "CustomizeTargetListGetTargetAmminimumFastSetGroupExcludedTarget" then
			...
			menu:AddLine("text", "|cffffff00手動添加排除目標","hasEditBox", 1, "editBoxText", "", "editBoxFunc", "AmminimumFastSetGroupExcludedTarget_ADD_EditUnit", "editBoxArg1", self,"editBoxArg2", index,"tooltipText",str,"tooltipTitle","目標名字"
			);
			
			
			
			menu:AddLine("text","|cffffff00選擇添加排除目標","hasArrow", 1, "value",
...
function addon:Menu_SuperTreatmentApiList(level, value, menu,TBL,GlobalLevel)
			...
			menu:AddLine("line",1,"LineBrightness",1,"LineHeight",8);			
			menu:AddLine("text", "|cffffff00函數模板|cff00ff00(更多功能)", "hasArrow", 1, "value", "",
